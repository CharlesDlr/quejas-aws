...
router.get("/quejas/:idsucursal", authorize, rolauth, async (req, res) => {
    try {
...
router.get("/quejas/:idejecutivo", authorize, rolauth, async (req, res) => {
    try {
...
router.get("/quejas/:idtipoqueja", authorize, rolauth, async (req, res) => {
    try {
